...
const std::map<EntityState, std::pair<const char *, int>> SamuraiAnimationPath =
    {{SamuraiState::WALK, {"resources/imgs/kinghts/Samurai/Walk.png", 9}},
     {SamuraiState::ATTACK1,
      {"resources/imgs/kinghts/Samurai/Attack_1.png", 4}},
     {SamuraiState::ATTACK2,
      {"resources/imgs/kinghts/Samurai/Attack_2.png", 5}},
     {SamuraiState::ATTACK3,
      {"resources/imgs/kinghts/Samurai/Attack_3.png", 4}},
