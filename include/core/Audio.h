...
const std::vector<std::string> musicPaths = {
    "resources/musics/bg.ogg",
    "resources/musics/Blaster.ogg",
    "resources/musics/Groove.ogg",
    "resources/musics/Space.ogg",
    "resources/musics/Stellar.ogg",
    "resources/musics/Victory.ogg",
