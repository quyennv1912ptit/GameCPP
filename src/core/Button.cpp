...
CombinedButton::CombinedButton(SDL_Renderer *rdr, const char *imgNormal, const char *imgHover, const char *fontPath, std::string text, float textSize, SDL_Color textClr, SDL_Color textHoverClr)
    : renderer(rdr)
{
...
CombinedButton::CombinedButton(SDL_Renderer *rdr, const char *imgNormal, const char *imgHover, float w, float h, const char *fontPath, std::string text, float textSize, SDL_Color textClr, SDL_Color textHoverClr)
    : renderer(rdr)
{
