...
TextBox::TextBox(SDL_Renderer *rdr, const char *path, std::string txt, float sz)
...
void TextBox::setPos(Vector2 pos) { dims.pos = pos; }
...
Transform TextBox::getDims() { return dims; }
