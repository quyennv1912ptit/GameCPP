...
HPBar::HPBar(float &MaxHP, float &CurrentHP, Transform &EntityTransform, SDL_Color BackgroundColor,
             SDL_Color ForegroundColor, float Height, float VerticalOffset, float Width)
    : maxHP(MaxHP), currentHP(CurrentHP), entityTransform(EntityTransform), backgroundColor(BackgroundColor),
      foregroundColor(ForegroundColor), height(Height), verticalOffset(VerticalOffset), width(Width)
{
