...
void PauseState::Enter() {
	...
	// title
	title = new TextBox(renderer, "resources/fonts/mightysouly.ttf",
	                    "-Game Paused-", 50);
	...
	// level
	level =
	    new TextBox(renderer, "resources/fonts/mightysouly.ttf", "level 1", 30);
	level->setPos({450, 165});

	// resume
	resumeBtn =
	    new CombinedButton(renderer, "resources/imgs/ui/playBtn.png",
	                       "resources/imgs/ui/playBtn_hovered.png", 50.0f,
	                       50.0f, "resources/fonts/mightysouly.ttf", "Resume",
	                       30.0f, {255, 255, 255, 255}, {100, 100, 100, 255});
	...
	// restart
	restartBtn =
	    new CombinedButton(renderer, "resources/imgs/ui/restartBtn.png",
	                       "resources/imgs/ui/restartBtn_hovered.png", 40.0f,
	                       40.0f, "resources/fonts/mightysouly.ttf", "Restart",
	                       30.0f, {255, 255, 255, 255}, {100, 100, 100, 255});
	...
	// quit
	quitBtn =
	    new CombinedButton(renderer, "resources/imgs/ui/quitBtn.png",
	                       "resources/imgs/ui/quitBtn_hovered.png", 40.0f,
	                       40.0f, "resources/fonts/mightysouly.ttf", "Quit",
	                       30.0f, {255, 255, 255, 255}, {100, 100, 100, 255});
