...
void PauseState::Enter()
{
    ...
    // resume
    resumeBtn = new CombinedButton(renderer, "resources/imgs/ui/playBtn.png", "resources/imgs/ui/playBtn_hovered.png",
                                   50.0f, 50.0f, "resources/fonts/mightysouly.ttf", "Resume", 30.0f,
    ...
    // restart
    restartBtn = new CombinedButton(
        renderer, "resources/imgs/ui/restartBtn.png", "resources/imgs/ui/restartBtn_hovered.png", 40.0f, 40.0f,
        "resources/fonts/mightysouly.ttf", "Restart", 30.0f, {255, 255, 255, 255}, {100, 100, 100, 255});
    Transform restartDims = restartBtn->getDims();
    restartBtn->setPos({1280.0f / 2 - restartDims.size.x / 2, 275});
    buttons.push_back(restartBtn);

    // quit
    quitBtn = new CombinedButton(renderer, "resources/imgs/ui/quitBtn.png", "resources/imgs/ui/quitBtn_hovered.png",
                                 40.0f, 40.0f, "resources/fonts/mightysouly.ttf", "Quit", 30.0f, {255, 255, 255, 255},
                                 {100, 100, 100, 255});
